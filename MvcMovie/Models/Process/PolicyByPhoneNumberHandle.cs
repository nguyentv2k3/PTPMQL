...
namespace MvcMovie.Models.Process
{
    ...
    public class PolicyByPhoneNumberHandle : AuthorizationHandler<PolicyByPhoneNumberRequirement>
    {
        private readonly IServiceProvider _serviceProvider;
        public PolicyByPhoneNumberHandle(IServiceProvider serviceProvider)
        {
